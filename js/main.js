const APIKey = `87575edefad644a6b6a102606241312`;
                        ...
                        <div class="card text-white">
                            ...
                            ${i === 0 ? `
                                ...
                                ${i === 0 ? `
                                    ...
                                    <img src="https:${weatherData.current.condition.icon}" alt="Weather Logo">` : `
                                    <p>${array[i].day.maxtemp_c} &deg;C</p>
                                    <p>${array[i].day.mintemp_c} &deg;C</p>
                                    <img src="https:${array[i].day.condition.icon}" alt="Weather Logo"/>
                                    `}
                                </div>
